...
// URL https://forum.arduino.cc/t/font-generation-for-bitmaps/161582/10
...
// This is a modified version of the dhepper bitmap font
// table in which the last or eighth byte of the table has
// been removed. This means that the decenders for the lower
// case letters have been removed and some punctuation marks
// such as comma or semicolon will also be clipped.
// However this does save memory!
...
// NOTE: Some bitmap font tables have the entries for each character in an
//       order which requires the processing of the table to be inverted.
//       When you are using such a bitmap table, the characters displayed
//       will be (1) upside down and (2) flipped. In other words each
//       character is flipped both horizontally, upside down, and vertically,
//       right to left pixels rather than left to right.
//
//       In order to accomodate such a table, you will need to add the flag
//       Font::FontTable::Flags_InvertBitOrder to the flags section of the
//       Font::font_table data. This flag will process the bitmap font data
//       in a reverse order so that it will display properly.

#if defined(USE_FONT_NONE)
static Font::FontTable Font::font_table = { 0, 0, 0, nullptr };
#else
#if defined(USE_FONT_5_B)
#if defined(SMALLER_FONT_TABLE)
static Font::FontTable Font::font_table = { Font::FontTable::Flags_UpperOnly | FontTable::Flags_RotateBits, 59, 5, (unsigned char *)font_table_local };
#else
static Font::FontTable Font::font_table = { 0, 95, 5, (unsigned char *)font_table_local };
#endif
#elif defined(USE_FONT_6_B)
#if defined(SMALLER_FONT_TABLE)
static Font::FontTable Font::font_table = { Font::FontTable::Flags_UpperOnly, 59, 6, (unsigned char *)font_table_local };
#else
static Font::FontTable Font::font_table = { 0, 95, 6, (unsigned char *)font_table_local };
#endif
#elif defined(USE_FONT_7_B)
#if defined(SMALLER_FONT_TABLE)
static Font::FontTable Font::font_table = { Font::FontTable::Flags_UpperOnly, 59, 7, (unsigned char *)font_table_local };
#else
static Font::FontTable Font::font_table = { 0, 95, 7, (unsigned char *)font_table_local };
#endif
#elif defined(USE_FONT_8_B)
#if defined(SMALLER_FONT_TABLE)
static Font::FontTable Font::font_table = { Font::FontTable::Flags_UpperOnly, 59, 8, (unsigned char *)font_table_local };
#else
static Font::FontTable Font::font_table = { 0, 95, 8, (unsigned char *)font_table_local };
#endif
#elif defined(USE_FONT_13_B)
#if defined(SMALLER_FONT_TABLE)
static Font::FontTable Font::font_table = { Font::FontTable::Flags_UpperOnly | Font::FontTable::Flags_InvertBitOrder, 59, 13, (unsigned char *)font_table_local };
#else
static Font::FontTable Font::font_table = { Font::FontTable::Flags_InvertBitOrder, 95, 13, (unsigned char *)font_table_local };
#endif
#elif defined(USE_FONT_16_B)
#if defined(SMALLER_FONT_TABLE)
static Font::FontTable Font::font_table = { Font::FontTable::Flags_UpperOnly, 59, 16, (unsigned char *)font_table_local};
#else
static Font::FontTable Font::font_table = { 0, 95, 16, (unsigned char *)font_table_local };
#endif
#endif
#endif

static void  Font::set_fonttable(unsigned short nRows, unsigned short nCols, unsigned char *pTable, unsigned char flags)
{
	font_table.bFlags = flags;
	font_table.nRows = nRows;
	font_table.nCols = nCols;
	font_table.table = pTable;
}

static unsigned char  Font::mod_fonttable(unsigned char flags)
{
	// save the current flag setting so that we can return it to the caller
	// should they decide to restore it later.
	// make sure that the Font::FontTable::Flags_UpperOnly state is maintained.
	unsigned char bFlagsSave = font_table.bFlags;

	font_table.bFlags = flags | ((Font::FontTable::Flags_UpperOnly | Font::FontTable::Flags_InvertBitOrder) & bFlagsSave);

	return bFlagsSave;
}

/*****************************************
 *The function name £º begin
 *Function  £º ³õÊ¼»¯ÀàÖÐµÄ³ÉÔ±±äÁ¿
 *Input  £º none
 *Output   £º none
 *Author   £ºKeDei
 *Time   £º2015/4/21
...
/*****************************************
 *The function name £º set_txt
 *Function  £º ÉèÖÃÎÄ±¾ÇøÓò£¬ÎÄ±¾ÇøÓòµÄ×óÉÏ×ø±ê(x0,y0),ÓÒÏÂ×ø±ê(x1,y1)£¬
			ÎÄ±¾µÄÑÕÉ«Îªtxt_b_color£»
			Èôtxt_b_colorÎªNULL Ôò²»ÏÔÊ¾ÑÕÉ«£¬0x0000Ò²Ò»ÑùµÄ ^.^
 *Input  £º none
 *Output   £º none
 *Author   £ºKeDei
 *Time   £º2015/4/21
...
/*****************************************
 *The function name £º clear_txt
 *Function  £º Çå³þµ±Ç°µÄÎÄ±¾ÄÚÈÝ
 *Input  £º color  £¨no used£©
 *Output   £º none
 *Author   £ºKeDei
 *Time   £º2015/4/21
 ****************************************/
...
#else
	if (font_flags & FontTable::Flags_UpperOnly) if (_data >= 'a') _data = _data - 'a' + 'A';
#endif
...
/*****************************************
 *The function name £º lcd_string
 *Function  £º ÏÔÊ¾×Ö·û´®
 *Input  £º *str
 *Output   £º none
 *Author   £º KeDei
